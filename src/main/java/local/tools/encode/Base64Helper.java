...
public final class Base64Helper {
    ...
    private static final char[] mapTable6BitToBase64 
                                            = new String(
    ...
    private static final byte[] mapTableBase64To6Bit = new byte[128];
    static {
        Arrays.fill(mapTableBase64To6Bit, (byte)-1);
        for (int i = 0; i < 64; ++i) {
            mapTableBase64To6Bit[mapTable6BitToBase64[i]] = (byte) i;
        }
    }
    ...
    public static String encodeLines(byte[] in) {
        return encodeLines(in, 0, in.length, 76, LINE_SEPARATOR);
    }
    ...
    public static String encode(byte[] in, int iOff, int iLen) {
        ...
        while (ip < iEnd) {
            ...
            int o3 = i2 & 0x3F;
            out[op++] = mapTable6BitToBase64[o0];
            out[op++] = mapTable6BitToBase64[o1];
            out[op] = op < oDataLen ? mapTable6BitToBase64[o2] : '=';
            op++;
            out[op] = op < oDataLen ? mapTable6BitToBase64[o3] : '=';
            op++;
        }
    ...
    public static byte[] decode(char[] in, int iOff, int iLen) {
        ...
        while (ip < iEnd) {
            ...
            int b0 = mapTableBase64To6Bit[i0];
            int b1 = mapTableBase64To6Bit[i1];
            int b2 = mapTableBase64To6Bit[i2];
            int b3 = mapTableBase64To6Bit[i3];
